...
class Pizza: 
    ...
    def __init__(self, size_input: str, toppings_input: int, gluten_free_input: bool):  # built-in function that stands for initialize
    ...
    def add_toppings(self, num_toppings: int) -> None:
        """Adding to the number of existing toppings and updating the pizza."""
